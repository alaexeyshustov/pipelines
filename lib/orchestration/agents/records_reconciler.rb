module Orchestration
  module Agents
    class RecordsReconciler < RubyLLM::Agent
      chat_model Chat
      tools Records::ReadSchemaTool, Records::TempFileTool, Records::SearchSimilarTool, Records::InsertRowsTool, Records::UpdateRowsTool, Records::ReadRowsTool
