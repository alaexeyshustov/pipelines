module Orchestration
  module Agents
    class RecordsNormalizer < RubyLLM::Agent
      chat_model Chat
      tools Records::ListRowsTool, Records::ReadRowsTool, Records::UpdateRowsTool, Records::ReadSchemaTool, Records::SearchSimilarTool
