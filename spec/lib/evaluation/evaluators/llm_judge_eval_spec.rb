...
RSpec.describe Evaluation::Evaluators::LLMJudgeEval do
  ...
  describe "#evaluate_and_store" do
    ...
    let!(:evaluation_experiment) { Evaluation::Experiment.create!(name: "test_exp", dataset: evaluation_dataset, status: :pending, prompt: evaluation_prompt, runner_class: "Evaluation::Sampler", evaluator_classes: [ "Evaluation::Evaluators::LLMJudgeEval" ]) }
