class NormalizeRecordsAgent < RubyLLM::Agent
  chat_model Chat
  tools ListTableRowsTool, ReadTableRowsTool, UpdateTableRowsTool, ReadTableSchemaTool
  ...
  instructions <<~INSTRUCTIONS
    ...
    3. Update the rows in the <destination_table> with the normalized values using update_table_rows tool, matching on the row ID and only updating the specified columns.
