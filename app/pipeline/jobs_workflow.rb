...
module Pipeline
  ...
  class JobsWorkflow
    ...
    MODELS_POOL = [ "mistral-large-latest", "gpt-4.1" ].freeze
    ...
    def build_tools
      ...
      Tools::ListEmailsTool.registry   = @registry
      Tools::GetEmailTool.registry     = @registry
      Tools::SearchEmailsTool.registry = @registry
      Tools::AddLabelsTool.registry    = @registry
      Tools::ClassifyEmailsTool.classifier = classifier

      [
        Tools::ListEmailsTool.new,
        Tools::GetEmailTool.new,
        Tools::SearchEmailsTool.new,
        Tools::AddLabelsTool.new,
        Tools::ClassifyEmailsTool.new,
        Tools::ManageDatabaseTool.new
      ]
    end
    ...
    def step1_init_database
      ...
      response     = run_agent(Agents::InitDatabaseAgent, @prompts.build_init_message)
    ...
    def step3_classify(new_emails)
      ...
      result   = run_agent(Agents::ClassifyAndFilterAgent, new_emails.to_json)
